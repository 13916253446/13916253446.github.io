  ...
  module.exports = {
      ...
      methods: {
          ...
          saveHandler: function() {
              ...
              //新增  
              if (this.add) {
                  var ArticalTypes = Bmob.Object.createWithoutData("ArticalTypes", this.typeObj.objectId);
                  ...
                  ArticalDetail.save().then(function(model) {
          ...
          if (array.length < 1) {
              ...
              query.find({
                  success: function(results) {
                      current.$store.state.ArticalTypeModel = JSON.parse(JSON.stringify(results || []));
                  },
